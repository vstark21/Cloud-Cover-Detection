...
class _EfficientNet(nn.Module):
    ...
    def __init__(self, blocks_args=None, global_params=None, in_channels=4):
        super().__init__()
...
class EfficientNet(_EfficientNet):
    def __init__(
        ...
        skip_connections = efficient_net_encoders[variant]['params']['skip_connections']
        model_name = efficient_net_encoders[variant]['params']['model_name']
        blocks_args, global_params = get_model_params(model_name, override_params=None)

        super().__init__(blocks_args, global_params, n_channels)
        ...
        self.out_channels = efficient_net_encoders[variant]['out_shapes']
